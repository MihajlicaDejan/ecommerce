        ...
        <div class="row bg-border-color medium-padding120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="cart">
                            <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary">{{Cart::content()->count()}} product</span></h1>
                        </div>
                                ...
                                @foreach(Cart::content() as $pdt)
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a href="{{route('delete.cart', $pdt->rowId)}}" class="product-del remove" title="Remove this item">
                                        ...
                                        <td class="product-thumbnail">
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    <img src="{{asset($pdt->model->image)}}" alt="{{$pdt->name}}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                </a>
                                        ...
                                        <td class="product-price">
                                            <h5 class="price amount">{{$pdt->price}}din</h5>
                                        </td>
